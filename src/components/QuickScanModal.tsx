  ...
  return (
    ...
    >
      <div className="space-y-4">
        {/* Toggle Scan Type */}
        <div className="grid grid-cols-2 gap-2 rounded-lg bg-zinc-950 p-1 border border-zinc-800">
          <button
            type="button"
            onClick={() => {
              setScanType('url');
        ...
        <form onSubmit={handleRunScan} className="space-y-3">
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-zinc-800 bg-zinc-950 px-3.5 py-2 text-xs text-zinc-100 placeholder-zinc-500 focus:border-zinc-700 focus:outline-hidden"
              required
            />
          </div>
            ...
            {scanType === 'url' ? (
              <>
                <button
                  ...
                  className="rounded-md border border-zinc-800 bg-zinc-950 px-2 py-0.5 text-[11px] text-zinc-400 hover:border-zinc-700 hover:text-zinc-200"
                >
                  Phishing Link
                </button>
                <button
          ...
          <div className="pt-3 flex justify-end gap-2 border-t border-zinc-800">
            <button
              ...
              className="rounded-lg border border-zinc-800 px-3 py-1.5 text-xs text-zinc-400 hover:bg-zinc-800 hover:text-zinc-200"
            >
              Cancel
            </button>
            <button
              ...
              className="flex items-center gap-2 rounded-lg bg-zinc-100 px-4 py-1.5 text-xs font-semibold text-zinc-900 hover:bg-white disabled:opacity-50 transition-colors"
            >
              {isScanning ? (
                <>
